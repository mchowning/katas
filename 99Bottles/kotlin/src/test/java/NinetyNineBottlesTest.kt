...
class NinetyNineBottlesTest {
    ...
    @Test fun first_verse() {
        val expected = """|99 bottles of beer on the wall, 99 bottles of beer.
                          |Take one down and pass it around, 98 bottles of beer on the wall.""".trimMargin()
        assertEquals(expected, subject.getVerse(99))
    }

    @Test fun another_verse() {
        val expected = """|3 bottles of beer on the wall, 3 bottles of beer.
                          |Take one down and pass it around, 2 bottles of beer on the wall.""".trimMargin()
        assertEquals(expected, subject.getVerse(3))
    }
    ...
    @Test fun verse_2() {
        ...
        assertEquals(expected, subject.getVerse(2))
    }
    ...
    @Test fun verse_1() {
        ...
        assertEquals(expected, subject.getVerse(1))
    }
    ...
    @Test fun verse_0() {
        ...
        assertEquals(expected, subject.getVerse(0))
    }

    @Test fun a_couple_verses() {
        val expected = """|2 bottles of beer on the wall, 2 bottles of beer.
                          ...
                          |Go to the store and buy some more, 99 bottles of beer on the wall.""".trimMargin()
        assertEquals(expected, subject.getVerses(2, 0))
    }

    @Test fun whole_song() {
        assertEquals(fullSong, subject.song())
    }

    private val fullSong: String
        get() = """|99 bottles of beer on the wall, 99 bottles of beer.
